...
import 'package:weather_app_bfs/ui/views/startup/startup_view.dart' as _i2;
import 'package:weather_app_bfs/ui/views/weather/weather_view.dart' as _i3;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i3.WeatherView: (data) {
      return _i4.MaterialPageRoute<dynamic>(
        builder: (context) => const _i3.WeatherView(),
        settings: data,
      );
    },
  };
